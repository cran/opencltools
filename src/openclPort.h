 ...
 *
 * Canonical copy for compilation in src/. Mirror in
 * inst/include/opencltools/openclPort.h for LinkingTo (OpenCL API headers are
 * not bundled; each package supplies -I via its own configure).
 *
