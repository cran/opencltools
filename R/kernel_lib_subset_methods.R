...
#'
#' @return Both S3 print methods are called for side effects. They write a structured
...
#'   }
#'
#' @example inst/examples/Ex_kernel_lib_subset_printing.R
